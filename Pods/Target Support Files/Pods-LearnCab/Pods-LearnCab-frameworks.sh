...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${PODS_ROOT}/Brightcove-Player-SDK-Player-UI/ios/dynamic/BrightcovePlayerUI.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/KKActionSheet/KKActionSheet.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/ZRScrollableTabBar/ZRScrollableTabBar.framework"
